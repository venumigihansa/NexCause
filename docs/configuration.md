...
| `BUILDPACK_RUNNER_IMAGE` | Deployment manager | No | `ghcr.io/venumigihansa/nexcause-buildpack-runner:0.1.3` | Configuration | Uses the released buildpack runner image. |
