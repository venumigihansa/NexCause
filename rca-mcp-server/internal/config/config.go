...
func Load() Config {
	return Config{
		...
		InternalServiceJWTSecret:   env("INTERNAL_SERVICE_JWT_SECRET", ""),
		DatabaseMaxOpenConnections: intEnv("DATABASE_POOL_MAX_SIZE", 5),
		DatabaseMaxIdleConnections: intEnv("DATABASE_POOL_MIN_SIZE", 1),
	}
}
